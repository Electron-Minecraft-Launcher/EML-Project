...
> [!TIP]
>
> - This example uses the _Agnostic mode_ (standalone), which means it doesn't require any backend server. But you can easily connect it to the [**EML AdminTool**](/docs/eml-admintool/system-requirements) later to manage your mods and configs remotely without updating the launcher itself.
...
The full API documentation is available on [here](/docs/eml-lib-and-launcher/api-reference/microsoftauth). Happy coding!
