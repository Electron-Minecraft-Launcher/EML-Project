...
description: Before installing the EML ecosystem, ensure that your server meets the necessary hardware and software requirements for optimal performance.
...
> [!WARNING]
> Launchers may make many requests to EML AdminTool. If your Minecraft server doesn't have a lot of players, you can use a VPS with low requirements. However, if you have a lot of players, you should use a VPS with high requirements, to avoid any performance issues or crashes.
...
> [!NOTE]
> For the rest of this tutorial, the domain `at.emlproject.com` will be used as an example.
...
- **Node.js and npm:** Version `20.x` (LTS) is recommended. A tutorial to install Node.js can be found at [Set up environment](/docs/set-up-environment).
