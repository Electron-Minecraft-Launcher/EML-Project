---
title: Files Updater and Loader
description: The Files Updater is the heart of your launcher's content management. This is where you decide exactly what your players will download and run. It handles both game content (mods, configs, resource packs) and the game engine (loader).
...
![Files Updater Overview](/images/files-updater.png)
...
![File Updater interface](/images/files-updater-file.png)

First, select the profile you want to manage from the tab at the top. If you only have one profile, the tabs will not be visible, and you will be managing the default profile.

Then you to create, upload, rename and delete files and folders. You can also edit some files directly in the browser, which is useful for small changes.
...
![Loader Settings modal](/images/files-updater-loader.png)
...
- **Loader:** Choose the modding API you want to use:
  ...
  - MCP version will be added soon.
- **Minecraft version:** The version of the game (e.g., `1.20.1`).
- **Loader version:** The specific version of Vanilla/Forge/NeoForge/Fabric/Quilt to use (usually the latest stable version recommended).
