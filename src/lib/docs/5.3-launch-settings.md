...
description: You can use Launcher to download and launch Minecraft. This guide explains how to configure the Launcher class and its options.
...
> [!WARNING]
> It is highly recommended to use Launcher with the [EML AdminTool](/docs/install-eml-admintool) website. Without it, you will not be able to download mods (including loaders such as Forge or Fabric), resource packs, and more.
...
| ------------------- | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| `url`               | `string`               | The URL of your EML AdminTool website, where is stored your modpack and loader info. If you don't set this value, the launcher will use the vanilla version of Minecraft (loaders such as Forge and Fabric are only available through the EML AdminTool).                                                                                                                                                                                                                                                                            | No but strongly recommended                                                                                                                         |
...
| `account`           | `Account`              | The player account (use [`MicrosoftAuth`](/docs/authentication), [`AzAuth`](/docs/-authentication) or [`CrackAuth`](/docs/authentication) to get the account, but you should **not** authenticate the user directly in the `config`, to be able to handle authentication). | Yes                                                                                                                                                 |
