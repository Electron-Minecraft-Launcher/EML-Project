...
> [!WARNING]
> It is highly recommended to use Launcher with the [EML AdminTool](/docs/install-eml-admintool) website. Without it, you will not be able to download mods (including loaders such as Forge), resource packs, and more.
