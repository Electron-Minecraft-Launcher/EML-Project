...
description: You can authenticate users with different methods in your Launcher. You can use MicrosoftAuth to authenticate users with Microsoft, AzAuth to authenticate users with Azuriom, and CrackAuth to authenticate users with a crack account.
