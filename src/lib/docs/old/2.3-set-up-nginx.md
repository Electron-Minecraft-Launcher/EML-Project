...
We assume you have already installed EML AdminTool by following the [installation guide](/docs/install-eml-admintool), and that you have a domaine name pointing to your server's public IP address.
