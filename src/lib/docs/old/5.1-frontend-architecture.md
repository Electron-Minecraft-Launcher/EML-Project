...
description: Whether you are using our EML Template or building your launcher from scratch, the interface is the most important part for your players. This guide defines the recommended architecture, necessary views, and best practices for connecting your UI to the EML logic.
...
<Tabs group="stack">
<TabItem label="Using EML Template">
...
<TabItem label="Building from scratch">
