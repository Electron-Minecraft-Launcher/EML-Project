...
> [!IMPORTANT]
> If you use the pre-configured template, you can skip this section and go directly to [Frontend architecture](/docs/frontend-architecture).
...
app.whenReady().then(async () => {
  ...
  const launcher = new EMLLib.Launcher({
    url: 'https://at.emlproject.pages.dev',               // Your EML AdminTool URL
