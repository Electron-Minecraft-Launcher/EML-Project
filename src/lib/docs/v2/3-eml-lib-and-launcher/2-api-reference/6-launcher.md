...
To use a custom loader, you are recommended to use EML AdminTool (see [Files Updater](/docs/eml-admintool/administration-and-features/files-updater#mod-loader-configuration)). 
