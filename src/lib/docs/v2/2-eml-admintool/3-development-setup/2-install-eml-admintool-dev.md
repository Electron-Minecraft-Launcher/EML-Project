...
> [!WARNING]
> This setup is intended for development only. Do not expose a local EML AdminTool instance to the internet without completing the [production setup](/docs/v2/eml-admintool/production-setup/install-docker) steps.
