...
> [!TIP]
> You can also edit permissions from the [Settings](/docs/v2/eml-admintool/administration-and-features/general-settings#user-management) page. Permissions are always in sync between the profile and the user management sections.
