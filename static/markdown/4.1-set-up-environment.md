...
If you want to focus on the launcher logic and design immediately without configuring Webpack, Vite, or TypeScript manually, use our official Starter Kit.
...
You can now start customizing your launcher by following the [User interface](#5.1-user-interface) and further chapters.
